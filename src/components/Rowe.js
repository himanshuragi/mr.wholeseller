...
function Rowe() {
      const data = [
            { src: e1, key: 1, price: '554', name: 'something', color: 'black', material: 'cotton' },
            { src: e2, key: 2, price: '555', name: 'something', color: 'black', material: 'cotton' },
            { src: e3, key: 3, price: '556', name: 'something', color: 'black', material: 'cotton' },
            { src: e4, key: 4, price: '557', name: 'something', color: 'black', material: 'cotton' },
            { src: e5, key: 5, price: '558', name: 'something', color: 'black', material: 'cotton' },
            { src: e6, key: 6, price: '559', name: 'something', color: 'black', material: 'cotton' },
            { src: e7, key: 7, price: '550', name: 'something', color: 'black', material: 'cotton' },
            { src: e8, key: 8, price: '554', name: 'something', color: 'black', material: 'cotton' },
            { src: e9, key: 9, price: '554', name: 'something', color: 'black', material: 'cotton' },
            { src: e10, key: 10, price: '554', name: 'something', color: 'black', material: 'cotton' }
      ]
